...
def get_fraud_data(rawTweets):
    ...
    return pd.DataFrame(result_data,
                        columns=[common.IDENTIFIER_TYPE, common.IDENTIFIER_VALUE, common.SOURCE, common.SCORE, common.CONTENT, common.VERIFIED_SCORE, common.FOLLOWERS_SCORE, common.FINAL_SCORE])
