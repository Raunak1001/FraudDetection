...
if __name__ == "__main__":
    ...
    if TEST_ENV:
        ...
        ch = int(input())
    if ch == 1:
        tweets_df = scrapper.get_tweets(keywords1=common.KEYWORDS, keywords2=['number','mobile'],from_time=fromDate, to_time=toDate, n=100, operator=common.OPERATOR_AND, mentions=common.MENTIONS)
        print("********** Got tweets ********")
